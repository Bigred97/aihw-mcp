...
Ported from the sister packages. Cache kinds are tuned for AIHW's cadence:
- "data": annual AIHW releases (GRIM, MORT, ACIM, etc.) — 7 days is conservative.
- "latest": short freshness window after publication.
- "register": weekly-updated registers (e.g. public hospitals lists) — 24 hours.
...
DEFAULT_DB_PATH = Path.home() / ".aihw-mcp" / "cache.db"
